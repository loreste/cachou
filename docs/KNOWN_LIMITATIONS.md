...
**Current line:** 1.0.x (patch-first; current **1.0.6**). **Stable** core is frozen; **experimental** kits may still change. See [ONE_POINT_OH.md](./ONE_POINT_OH.md).
...
- Prefer pinning `cachoujs@^1.0.6` in production apps and reading the [changelog](../CHANGELOG.md).
