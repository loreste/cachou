...
**Current line:** 0.6.x (patch-first; current **0.6.4**). Public APIs may still change before 1.0.
...
- Control-flow helpers (`Show` / `For` / `Switch`) are unwrapped correctly on SSR and as mount roots (0.6.4+).
