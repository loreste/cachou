...
**Current line:** 0.4.x (patch-first; current **0.4.12**). Public APIs may still change before 1.0.
...
- Control-flow helpers (`Show` / `For` / `Switch`) are unwrapped correctly on SSR and as mount roots (0.4.12+).
