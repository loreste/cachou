...
|---------|---------|------------|
| [`cachoujs`](https://www.npmjs.com/package/cachoujs) | **0.4.6** | Runtime, Vite plugin, helpers |
| [`@cachoujs/compiler`](https://www.npmjs.com/package/@cachoujs/compiler) | **0.4.6** | Pure-JS `.cachou` compiler |
| [`@cachoujs/create`](https://www.npmjs.com/package/@cachoujs/create) | **0.4.6** | `npx` app scaffold |
