...
|---------|------|---------|
| `cachoujs` | repo root | 1.0.8 |
| `@cachoujs/compiler` | `packages/compiler` | 1.0.8 |
| `@cachoujs/create` | `packages/create-cachou` | 1.0.8 |
...
Update root [CHANGELOG.md](../CHANGELOG.md) **first**, under a new version heading (e.g. `## 1.0.8`):
...
npm **forbids** republishing the same version. Always bump (next: **1.0.9**):
