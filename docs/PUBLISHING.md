...
|---------|------|---------|
| `cachoujs` | repo root | 0.5.0 |
| `@cachoujs/compiler` | `packages/compiler` | 0.5.0 |
| `@cachoujs/create` | `packages/create-cachou` | 0.5.0 |
...
Update root [CHANGELOG.md](../CHANGELOG.md) **first**, under a new version heading (e.g. `## 0.5.0`):
...
npm **forbids** republishing the same version. Always bump (next: **0.5.1**):
