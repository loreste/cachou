...
|---------|------|---------|
| `cachoujs` | repo root | 1.0.7 |
| `@cachoujs/compiler` | `packages/compiler` | 1.0.7 |
| `@cachoujs/create` | `packages/create-cachou` | 1.0.7 |
...
Update root [CHANGELOG.md](../CHANGELOG.md) **first**, under a new version heading (e.g. `## 1.0.7`):
...
npm **forbids** republishing the same version. Always bump (next: **1.0.8**):
