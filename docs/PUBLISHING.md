...
Update root [CHANGELOG.md](../CHANGELOG.md) **first**, under a new version heading (e.g. `## 1.0.6`):
...
npm **forbids** republishing the same version. Always bump (next: **1.0.7**):
