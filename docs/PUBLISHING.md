...
|---------|------|---------|
| `cachoujs` | repo root | 0.4.9 |
| `@cachoujs/compiler` | `packages/compiler` | 0.4.9 |
| `@cachoujs/create` | `packages/create-cachou` | 0.4.9 |
...
Update root [CHANGELOG.md](../CHANGELOG.md) **first**, under a new version heading (e.g. `## 0.4.10`):
...
npm **forbids** republishing the same version. Always bump (next: **0.4.10**):
