...
CachouJS **1.0** freezes the **stable** core’s API compatibility contract. Published line is **1.0.x** (current: **1.0.11**). Experimental kits may still change — pin tightly. This does not certify production maturity or security. Read the [changelog](../CHANGELOG.md) and [ONE_POINT_OH.md](./ONE_POINT_OH.md).
