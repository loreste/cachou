# How to: use framework APIs (mutations, islands, composition)

Quick recipes for the library surface beyond basic signals/templates
(current line: **0.6.x**).  

Full tutorial: [Get Started](../GETTING_STARTED.md) · Reference: [API.md](../API.md) · Stability: [STABILITY.md](../STABILITY.md).
