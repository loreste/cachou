...
| **Version** | **1.0.10** (stable core API; patch-first) |
...
| Version mismatch | `npm view cachoujs version` should show **1.0.x** |
...
```bash
npm install cachoujs                 # runtime + vite plugin  (1.0.7)
