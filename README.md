...
**v1.0.6** · stable core (experimental kits still opt-in)
...
- **1.0.6** on npm. The stable core is API-frozen; patch releases are the default. This is an API compatibility commitment, not evidence of broad production adoption.
